...
I'm The kishu Music Bot! A Powerful Bot to Play Music in Your Group Voice Chat 😇!
...
Made with ❤️ **@{UPDATES_CHANNEL}**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "Source Code 📦", url="https://github.com/kishannn07/music"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Support Group ⚜️", url="https://t.me/music_addict_group"
                    )
                ]
            ]
        )
...
**Supported Url List:** @music_addict_group
