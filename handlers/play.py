...
from config import DURATION_LIMIT, LOG_CHANNEL, BOT_USERNAME, THUMB_URL, KISHU_QUE
...
PLAYMSG_BUTTONS = InlineKeyboardMarkup(
    [
            [
                ...
                InlineKeyboardButton("☑️ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/music_addict_group"),
            ],
...
async def nplay(_, message: Message):
    ...
    bttn = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇꜱ", url=f"https://t.me/music_addict_group")
            ],[
