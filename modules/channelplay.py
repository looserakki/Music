...
from config import DURATION_LIMIT, ASSISTANT_NAME
from config import UPDATES_CHANNEL as updateschannel
from config import que
from helpers.admins import get_administrators
from helpers.decorators import authorized_users_only
from helpers.gets import get_file_name
from modules.play import arq, cb_admin_check, generate_cover
...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    # print(e)
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {ASSISTANT_NAME} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(text="🗑️", callback_data="ccls")],
            ]
        )
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📖 Playlist", callback_data="cplaylist"),
                    InlineKeyboardButton("🗑️", callback_data="ccls"),
                ],
                [
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> the song requested by {} via kishu Music 😘 in Linked Channel".format(
...
async def jiosaavn(client: Client, message_: Message):
        ...
        [
            ...
            [
                InlineKeyboardButton(
                    text="Join Channel", url=f"https://t.me/UNIVERSAL_OP_CHAT"
                )
            ]
        ]
    )
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"Playing {sname} Via kishusaavn in linked channel",
    )
    os.remove("final.png")
